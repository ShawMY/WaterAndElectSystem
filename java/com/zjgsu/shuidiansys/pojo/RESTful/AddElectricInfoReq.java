...
public class AddElectricInfoReq {
    ...
    public String getForthAddress() {
        return forthAddress;
    }

    public void setForthAddress(String forthAddress) {
        this.forthAddress = forthAddress;
    }
